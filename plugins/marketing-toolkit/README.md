...
**Make the docs you generate as good as the code they describe.** Skills for the last-mile polish that turns a working thing into a thing people actually try — for [Claude Code](https://claude.com/claude-code).
...
Skills are invoked as `/marketing-toolkit:<skill>`, or auto-invoked when the conversation matches their description.
